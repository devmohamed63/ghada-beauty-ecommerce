...
<head>
    ...
    <title>@yield('title', 'Ghada Beauty')</title>
    
    {{-- SEO Meta Tags --}}
    <meta name="description" content="@yield('description', 'منتجات أصلية 100% للعناية بالبشرة والشعر. تفتيح – ترطيب – علاج – نضارة. توصيل لجميع المحافظات والدفع عند الاستلام.')">
    ...
    {{-- Open Graph Tags --}}
    <meta property="og:title" content="@yield('title', 'Ghada Beauty')">
    <meta property="og:description" content="@yield('description', 'منتجات أصلية 100% للعناية بالبشرة والشعر. تفتيح – ترطيب – علاج – نضارة.')">
    ...
    <meta name="twitter:title" content="@yield('title', 'Ghada Beauty')">
    <meta name="twitter:description" content="@yield('description', 'منتجات أصلية 100% للعناية بالبشرة والشعر.')">
