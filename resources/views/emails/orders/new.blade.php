        ...
        <div class="content">
            ...
            <div class="order-info">
                ...
                <div class="info-row">
                    ...
                    <span class="value">{{ $order->governorate->name_ar }}</span>
                </div>
                <div class="info-row">
                    <span class="label">المدينة:</span>
                    <span class="value">{{ $order->city->name_ar }}</span>
                </div>
                <div class="info-row">
            ...
            <div class="total">
                الإجمالي: {{ number_format($order->total, 2) }} جنيه
            </div>
        </div>

        <div class="footer">
            <p>هذا البريد الإلكتروني تم إرساله تلقائياً من Ghada Beauty</p>
            <p>© {{ date('Y') }} Ghada Beauty. جميع الحقوق محفوظة.</p>
        </div>
    </div>
</body>
</html>
