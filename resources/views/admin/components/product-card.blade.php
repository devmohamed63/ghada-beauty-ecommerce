...
<div class="bg-white rounded-2xl shadow-sm border border-pink-100 overflow-hidden hover:shadow-md transition-all">
    <div class="flex gap-4 p-4">
        <img src="{{ $product->getMainImageUrl('thumb') }}" alt="{{ $product->name }}" class="w-20 h-20 md:w-24 md:h-24 object-cover rounded-xl flex-shrink-0">
        <div class="flex-1 min-w-0">
            ...
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-pink-600 font-bold">{{ number_format($product->price, 0) }} جنيه</p>
