...
<div class="space-y-6 md:space-y-8">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-pink-100 p-6 md:p-8">
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="<?php echo e(route('admin.products.index')); ?>" class="text-pink-600 hover:text-pink-700 text-sm font-medium">
                عرض الكل →
            </a>
        </div>
            ...
            <div class="space-y-4">
                <?php $__currentLoopData = $bestSellers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="flex items-center gap-4 p-4 rounded-xl hover:bg-pink-50 transition-colors border-b border-gray-100 last:border-0">
                        <img src="<?php echo e($product->getMainImageUrl('thumb')); ?>" alt="<?php echo e($product->name); ?>" class="w-16 h-16 md:w-20 md:h-20 object-cover rounded-xl shadow-sm">
                        <div class="flex-1 min-w-0">
                            <h3 class="font-bold text-gray-800 mb-1 line-clamp-1"><?php echo e($product->name); ?></h3>
                            <p class="text-sm text-gray-600 mb-2"><?php echo e($product->category->name ?? 'بدون فئة'); ?></p>
                            <div class="flex items-center gap-3">
                                <span class="text-lg font-bold text-pink-600"><?php echo e(number_format($product->price, 2)); ?> جنيه</span>
                                <?php if($product->is_best_seller): ?>
                                    <span class="px-2 py-1 bg-orange-500 text-white text-xs rounded-full">الأكثر مبيعاً</span>
                                <?php endif; ?>
                            </div>
                        </div>
                        <a href="<?php echo e(route('admin.products.edit', $product)); ?>" class="p-2 text-blue-600 hover:bg-blue-50 rounded-lg transition-colors flex-shrink-0">
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\freelance\ghada beauty\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>