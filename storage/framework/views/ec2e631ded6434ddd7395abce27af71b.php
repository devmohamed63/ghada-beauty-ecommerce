...
<div class="bg-white rounded-2xl shadow-sm border border-pink-100 p-6 hover:shadow-lg transition-all duration-300 hover:scale-105">
    <div class="flex items-center justify-between mb-4">
        <div class="w-14 h-14 <?php echo e($bgColor); ?> rounded-2xl flex items-center justify-center shadow-sm">
            <div class="text-2xl">
                <?php echo $icon ?? ''; ?>
    ...
    <h3 class="text-gray-600 text-sm font-medium mb-2"><?php echo e($title ?? ''); ?></h3>
    <p class="text-3xl font-bold <?php echo e($textColor); ?>"><?php echo e($value ?? '0'); ?></p>
</div>

<?php /**PATH D:\freelance\ghada beauty\resources\views/admin/components/stat-card.blade.php ENDPATH**/ ?>