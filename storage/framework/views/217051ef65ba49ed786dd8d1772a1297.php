<?php $__env->startSection('title', 'من نحن - Ghada Beauty | قصتنا ورؤيتنا'); ?>

<?php $__env->startSection('description', 'تعرفي على Ghada Beauty - متخصصون في توفير أفضل منتجات العناية بالبشرة والشعر الأصلية 100%. منتجات مصرية أصلية بأسعار مناسبة.'); ?>
    ...
    <div class="container py-12">
        ...
        <div class="mt-16 text-center">
            ...
            <div class="flex flex-wrap gap-4 justify-center">
                <a href="<?php echo e(route('products.index')); ?>" class="btn-primary">تصفح المنتجات</a>
...
<?php echo $__env->make('front.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\freelance\ghada beauty\resources\views/front/pages/about.blade.php ENDPATH**/ ?>