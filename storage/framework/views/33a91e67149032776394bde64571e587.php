    ...
    <div class="container">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="<?php echo e(route('home')); ?>" class="text-gray-600 hover:text-pink-500 transition-colors text-sm">الرئيسية</a></li>
                    <li><a href="<?php echo e(route('products.index')); ?>" class="text-gray-600 hover:text-pink-500 transition-colors text-sm">المنتجات</a></li>
                    <li><a href="<?php echo e(route('routine')); ?>" class="text-gray-600 hover:text-pink-500 transition-colors text-sm">روتين البشرة</a></li>
                    <li><a href="<?php echo e(route('about')); ?>" class="text-gray-600 hover:text-pink-500 transition-colors text-sm">من نحن</a></li>
                    <li><a href="<?php echo e(route('contact')); ?>" class="text-gray-600 hover:text-pink-500 transition-colors text-sm">تواصل معنا</a></li>
                </ul>
            </div>
        ...
        <div class="border-t border-pink-100 pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
            <p class="text-gray-600 text-center md:text-right text-sm">
                &copy; <?php echo e(date('Y')); ?> Ghada Beauty - جميع الحقوق محفوظة
            </p>
            <div class="flex gap-4 text-sm">
                <a href="<?php echo e(route('privacy')); ?>" class="text-gray-600 hover:text-pink-500 transition-colors">سياسة الخصوصية</a>
                <span class="text-gray-300">|</span>
                <a href="<?php echo e(route('terms')); ?>" class="text-gray-600 hover:text-pink-500 transition-colors">الشروط والأحكام</a>
            </div>
        </div>
    </div>
</footer>
<?php /**PATH D:\freelance\ghada beauty\resources\views/front/layouts/footer.blade.php ENDPATH**/ ?>