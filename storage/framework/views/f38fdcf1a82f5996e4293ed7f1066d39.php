<?php $__env->startSection('title', 'Ghada Beauty - منتجات عناية بالبشرة أصلية 100% | تفتيح - ترطيب - نضارة'); ?>
        ...
        <div class="grid md:grid-cols-2 gap-12 items-center">
            <div class="space-y-6">
                ...
                <div class="flex flex-wrap gap-4">
                    <a href="<?php echo e(route('products.index')); ?>" aria-label="تصفح جميع المنتجات" class="btn-primary inline-block hover:scale-105 transform transition-all min-h-[48px] px-6 py-3 flex items-center justify-center touch-manipulation">
                        شوفي المنتجات
                    </a>
                    <a href="<?php echo e(route('routine')); ?>" aria-label="اختيار روتين البشرة المناسب" class="btn-secondary inline-block hover:scale-105 transform transition-all min-h-[48px] px-6 py-3 flex items-center justify-center touch-manipulation">
                        اختاري روتين بشرتك
                    </a>
                </div>
            ...
            <div class="relative">
                <div class="relative z-10 rounded-3xl overflow-hidden shadow-2xl hover:shadow-3xl transition-shadow duration-500">
                    <img
                        ...
                        class="w-full h-auto"
                        loading="eager"
                        onerror="this.src='<?php echo e(asset('images/hero-placeholder.jpg')); ?>'; this.onerror=null;"
                    />
                </div>
...
<section class="py-20 bg-gradient-to-br from-pink-50 via-white to-purple-50">
    <div class="container">
        ...
        ?>
        <?php if($hasBestSellers): ?>
        <div class="relative px-4" x-data="bestSellersSlider(<?php echo e(count($bestSellersProducts)); ?>)">
            <div class="overflow-hidden">
                <div class="flex transition-transform duration-700 ease-in-out" :style="`transform: translateX(${currentSlide * (100 / slidesToShow)}%)`">
                    <?php $__currentLoopData = $bestSellersProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="group bg-white rounded-3xl shadow-md hover:shadow-2xl transition-all duration-500 overflow-hidden border border-pink-100 hover:border-pink-300">
                            <a href="<?php echo e(route('products.show', $product->slug)); ?>">
                                <div class="relative overflow-hidden aspect-square bg-gradient-to-br from-pink-50 to-purple-50">
                                    <img src="<?php echo e($product->getMainImageUrl('medium')); ?>" alt="<?php echo e($product->name); ?>" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700">
                            ...
                            <div class="p-6">
                                ...
                                <div class="flex items-center justify-between pt-2 border-t border-pink-50">
                                    <div>
                                        <span class="text-pink-600 text-2xl font-bold"><?php echo e(number_format($product->price, 0)); ?></span>
                                        <span class="text-gray-500 text-sm mr-1">جنيه</span>
                                    </div>
                                    <button onclick="addToCart(<?php echo e($product->id); ?>, 1, event)" class="bg-gradient-to-r from-pink-500 to-teal-500 text-white px-5 py-2.5 rounded-full text-sm hover:shadow-xl transition-all flex items-center gap-2 group-hover:scale-110 hover:from-pink-600 hover:to-teal-600">
            ...
            <div class="flex justify-center gap-2.5 mt-10">
                <template x-for="i in Math.ceil(<?php echo e(count($bestSellersProducts)); ?> - slidesToShow + 1)" :key="i">
        ...
        <div class="text-center mt-12">
            <a href="<?php echo e(route('products.index')); ?>" class="btn-primary inline-block">شوفي جميع المنتجات</a>
        </div>
    </div>
</section>
        ...
        <div class="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <a href="<?php echo e(route('routine')); ?>" class="bg-gradient-to-br from-pink-50 to-pink-100 hover:from-pink-100 hover:to-pink-200 border-2 border-pink-200 hover:border-pink-300 p-5 rounded-2xl text-center transition-all hover:shadow-lg hover:-translate-y-1 group">
                    ...
                    <a href="<?php echo e(route('routine')); ?>" class="bg-gradient-to-br from-purple-50 to-purple-100 hover:from-purple-100 hover:to-purple-200 border-2 border-purple-200 hover:border-purple-300 p-5 rounded-2xl text-center transition-all hover:shadow-lg hover:-translate-y-1 group">
                        <span class="text-3xl mb-2 block group-hover:scale-110 transition-transform">🌸</span>
                        <span class="text-gray-700 font-medium">بشرة جافة</span>
                    </a>
                    <a href="<?php echo e(route('routine')); ?>" class="bg-gradient-to-br from-teal-50 to-teal-100 hover:from-teal-100 hover:to-teal-200 border-2 border-teal-200 hover:border-teal-300 p-5 rounded-2xl text-center transition-all hover:shadow-lg hover:-translate-y-1 group">
                        <span class="text-3xl mb-2 block group-hover:scale-110 transition-transform">✨</span>
                ...
                <a href="<?php echo e(route('routine')); ?>" class="btn-primary inline-block hover:scale-105 transform transition-all">شوفي جميع الروتينات</a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="bg-white p-8 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 border border-pink-100 hover:border-pink-300 hover:-translate-y-2 group">
                ...
                <p class="text-gray-600 mb-6 leading-relaxed">"<?php echo e($review['review']); ?>"</p>
                <div class="flex items-center gap-3 pt-4 border-t border-pink-50">
                    ...
                    <p class="text-pink-600 font-medium"><?php echo e($review['name']); ?></p>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
...
<?php echo $__env->make('front.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\freelance\ghada beauty\resources\views/front/home.blade.php ENDPATH**/ ?>